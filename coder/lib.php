...
function coder_add_instance(stdClass $data, mod_coder_mod_form $mform = null) {
    ...
    $data->outputexample    = $data->outputexample ?? '<div>Welk woordje wil je versleutelen? <strong><em>hallo</em></strong><br>Welke sleutel wil je gebruiken? <strong><em>3</em></strong><br>De versleuteling van pizza is kdoor</div>';
